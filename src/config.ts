...
import { PRIVATE_KEY as privateKey, GRPC_URL } from './env'

export const owner: Keypair = Keypair.fromSecretKey(bs58.decode(privateKey))
export const connection = new Connection(GRPC_URL)
export const txVersion = TxVersion.V0 // or TxVersion.LEGACY
// const cluster = 'mainnet' // 'mainnet' | 'devnet'
const cluster =  GRPC_URL.indexOf('devnet') !== -1 ? 'devnet' : 'mainnet' // 'mainnet' | 'devnet'
